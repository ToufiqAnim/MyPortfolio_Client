...
const Project = ({projectData}) => {
  ...
  return (
    ...
    <div className="bg-[#112240] rounded-lg shadow-lg overflow-hidden">
        <img src={projectData?.image} alt={projectData?.title} className="w-full"/>
        <div className="p-6">
        ...
        <button>    <Link to={`/projects/${projectData?._id}`} className='bg-white text-black px-6 py-3 '>Know More</Link></button>
        </div>
    </div>
</div>
  )
